...
local TileEditor = mods.requireFromPlugin("ui.widgets.fancy_tile_entities_editor")
local contextMenu = require("ui.context_menu")
local configs = require("configs")

local buttonField = {}

buttonField.fieldType = "FancyTileEntities.buttonStringField"
...
function buttonField.getElement(name, value, options)
    ...
    local buttonWithContext = contextMenu.addContextMenu(
        ...
        function()
            ...
            return TileEditor.getTileEditor(formField, editOptions)
        end,
        {
